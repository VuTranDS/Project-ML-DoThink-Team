...
def save(img,name, bbox, width=150,height=150):
    x, y, w, h = bbox
    imgCrop = img[y:h, x: w]
    print(imgCrop.shape)
...
def faces(frame):
    ...
    # frame =cv2.imread('C:\\Users\\Tuanv\\Downloads\\Demo\\pre_image\\vdz.jpg')
    ...
    for counter,face in enumerate(faces):
        ...
        save(frame,new_path+str(random.randint(1,1000)),(x1,y1,x2,y2))
        # save(gray,new_path+str(counter),(x1,y1,x2,y2))
    frame = cv2.resize(frame,(800,800))
    print("Saving photo successfully")